// Redeploy trigger March 26 2026
...
const AIFundingTracker = lazy(() => import("./pages/AIFundingTracker"));
...
const router = createBrowserRouter([
  {
    ...
    children: [
      ...
      { path: "/tools/funding-tracker", element: <AIFundingTracker /> },
      { path: "/tools/events-calendar", element: <AIEventsCalendar /> },
      ...
      { path: "/3B9", element: <ThreeBeforeNineLatest /> },
      { path: "/3b9", element: <ThreeBeforeNineLatest /> },
      ...
      // Category alias redirects (before /:slug catch-all)
      { path: "/news", element: <Navigate to="/category/news" replace /> },
      { path: "/business", element: <Navigate to="/category/business" replace /> },
      { path: "/create", element: <Navigate to="/category/create" replace /> },
      { path: "/learn", element: <Navigate to="/category/learn" replace /> },
      { path: "/life", element: <Navigate to="/category/life" replace /> },
      { path: "/policy", element: <Navigate to="/category/policy" replace /> },
      { path: "/voices", element: <Navigate to="/category/voices" replace /> },
      { path: "/asean", element: <Navigate to="/category/asean" replace /> },
      { path: "/north-asia", element: <Navigate to="/category/north-asia" replace /> },
      { path: "/south-asia", element: <Navigate to="/category/south-asia" replace /> },
      { path: "/greater-china", element: <Navigate to="/category/greater-china" replace /> },
      { path: "/oceania", element: <Navigate to="/category/oceania" replace /> },
      { path: "/anglosphere", element: <Navigate to="/category/anglosphere" replace /> },
      { path: "/europe", element: <Navigate to="/category/europe" replace /> },
      { path: "/mena", element: <Navigate to="/category/mena" replace /> },
      { path: "/africa", element: <Navigate to="/category/africa" replace /> },
      { path: "/latin-america", element: <Navigate to="/category/latin-america" replace /> },
      { path: "/pan-pacific", element: <Navigate to="/category/pan-pacific" replace /> },
      { path: "/pan-asia", element: <Navigate to="/category/pan-asia" replace /> },
      { path: "/global-comparison", element: <Navigate to="/category/global-comparison" replace /> },
