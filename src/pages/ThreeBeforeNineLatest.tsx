  ...
  if (isLoading) {
    return (
      <div className="min-h-screen bg-slate-900 flex items-center justify-center">
        <SEOHead title="3 Before 9 - Daily AI Briefing" description="The latest 3 Before 9 morning briefing from AI in ASIA."
        canonical="https://aiinasia.com/news/3-before-9" noIndex={true} />
