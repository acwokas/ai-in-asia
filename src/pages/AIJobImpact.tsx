...
export default function AIJobImpact() {
  ...
  const handleAnalyse = () => {
    ...
    if (!matchedRole) {
      ...
      const genericRole: RoleData = {
        ...
        aiAdvantages: [
          "Use AI assistants to automate routine work",
          "Leverage AI analytics for better decisions",
  ...
  const handleShare = (platform: "twitter" | "linkedin" | "copy") => {
    ...
    if (platform === "copy") {
      ...
      window.open(
        `https://x.com/intent/tweet?text=${encodeURIComponent(text)}&url=${encodeURIComponent(url)}&via=AI_in_Asia`,
        "_blank"
      );
    } else {
      window.open(
        ...
        <main id="main-content" className="flex-1">
          ...
          <section className="border-b border-border/40">
            <div className="container mx-auto px-4 py-16 md:py-24 max-w-3xl text-center">
              ...
              {/* Calculator Form */}
              <Card className="p-6 md:p-8 text-left max-w-lg mx-auto border-border/60">
              ...
              <div className="container mx-auto px-4 py-16 max-w-4xl">
                ...
                <div className="grid md:grid-cols-3 gap-5 mb-10">
                  <InsightCard
                    icon={AlertTriangle}
                    title="Tasks at Risk"
                    items={result.role.automatableTasks}
                    color="hsl(0, 84%, 60%)"
                  />
                  <InsightCard
                    icon={Shield}
                    title="Tasks That Stay Human"
                    items={result.role.humanTasks}
                    color="hsl(142, 71%, 45%)"
                  />
                  <InsightCard
                    icon={TrendingUp}
                    title="Your AI Advantage"
                    items={result.role.aiAdvantages}
                  ...
                  <Card className="p-5 border-border/60">
                    <div className="flex items-center gap-2 mb-3">
                      ...
                      <h3 className="font-semibold text-foreground">
                        AI Landscape in {result.country.name}
                      </h3>
                    </div>
                    <p className="text-sm text-muted-foreground">
                      {result.country.regulatoryContext}
                    </p>
                    <div className="mt-3 text-xs text-muted-foreground">
                      Adoption speed:{" "}
                      <span className="font-medium text-foreground">
                        {result.country.adoptionMultiplier >= 1.15
                          ? "Very High"
                          : result.country.adoptionMultiplier >= 1.0
                          ? "High"
                          : result.country.adoptionMultiplier >= 0.85
                          ? "Moderate"
                          : "Developing"}
                      </span>
                    </div>
                    ...
                    <div className="flex items-center gap-3">
                      <div className="flex-1 bg-muted rounded-full h-3 overflow-hidden">
                        <div
                          ...
                          style={{
                            width: `${Math.min(100, (result.role.impactTimelineYears[1] / 15) * 100)}%`,
                          }}
                        />
                      </div>
                ...
                <div className="text-center">
                  ...
                  <div className="flex items-center justify-center gap-2">
                    <Button variant="outline" size="sm" onClick={() => handleShare("copy")} className="gap-1.5">
                    ...
                    <Button variant="outline" size="sm" onClick={() => handleShare("linkedin")} className="gap-1.5">
          ...
          <section className="container mx-auto px-4 py-16 max-w-3xl">
            ...
            <div className="grid gap-4 mb-12">
              {[
                {
                  title: "How AI Is Reshaping Jobs Across Southeast Asia",
                  slug: "/category/business",
                  desc: "Explore our coverage of AI-driven workforce changes",
                },
                {
                  title: "AI Policy Atlas — Regulation by Country",
                  slug: "/ai-policy-atlas",
                  desc: "See how different countries are regulating AI",
                },
                {
                  title: "AI Guides — Upskill for the AI Era",
                  slug: "/guides",
                  desc: "Practical guides to using AI tools in your career",
                },
              ].map((link) => (
