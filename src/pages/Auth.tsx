...
const Auth = () => {
  ...
  const { signIn, signUp, signInWithGoogle, resetPassword, updatePassword, user, loading: authLoading } = useAuth();
          ...
          <Tabs defaultValue="signin">
            ...
            <TabsContent value="signin">
              ...
              <Button
                type="button"
                variant="outline"
                className="w-full mb-4 bg-white text-gray-800 hover:bg-gray-50 border-border dark:bg-white dark:text-gray-800 dark:hover:bg-gray-100"
