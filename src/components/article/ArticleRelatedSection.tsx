      ...
      <div className="container mx-auto px-4 max-w-6xl">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
          {relatedArticles.map((article) => (
            <div key={article.id} onMouseDown={() => { window.dataLayer = window.dataLayer || []; window.dataLayer.push({ event: "related_article_click", article_title: article.title, article_slug: article.slug }); }}>
              <ArticleCard
                title={article.title}
