...
const PolicyBreadcrumbs = ({ regionName, regionSlug, articleTitle }: PolicyBreadcrumbsProps) => {
  return (
    <nav className="sticky top-16 z-10 bg-background/95 backdrop-blur supports-[backdrop-filter]:bg-background/60 py-4 -mt-4 mb-6 border-b flex items-center gap-2 text-sm" aria-label="Breadcrumb">
      <Link 
        to="/ai-policy-atlas" 
