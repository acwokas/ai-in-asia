 ...
 * Always JPEG, 1200Ã630, â¤250 KB.
 */
 ...
 * Returns a File named `{baseName}-og.jpg`, always âj$250 KB.
 */
export const compressForOG = async (
  ...
  // Cover-fit: scale to fill 1200Ã630, center-crop any overflow
  ...
  // Encode as JPEG, reducing quality until âj$250 KB
  let quality = 0.82;
    ...
    reader.onload = (e) => {
      ...
      img.onload = () => {
        ...
        if (couldHaveAlpha) {
          ...
          // Sample every 4th pixel for speed â still catches transparent regions
