...
export const JARGON_DICTIONARY: JargonEntry[] = [
  // === TECHNICAL BUZZWORDS ===
  { term: "LLM", plain: "A large language model, meaning software trained on massive text data to generate human-like text.", brutal: "A very expensive autocomplete that sometimes hallucinates.", eli5: "A robot that read the whole internet and now tries to talk like a person.", sassLevel: 1, category: "technical" },
  ...
  { term: "multimodal", plain: "AI that can process multiple types of input like text, images, and audio.", brutal: "It can look at pictures AND read. Revolutionary.", eli5: "An AI that can see, hear, and read, just like you!", sassLevel: 2, category: "technical" },
  ...
  { term: "NLP", plain: "Natural Language Processing, the field of teaching computers to understand and generate human language.", brutal: "Making computers read. They're still not great at it.", eli5: "Teaching robots to understand what people say and write.", sassLevel: 1, category: "technical" },
  ...
  { term: "AGI", plain: "Artificial General Intelligence, a hypothetical AI that matches human-level intelligence across all tasks.", brutal: "The thing tech CEOs promise is '2 years away' every single year.", eli5: "A robot as smart as a person at everything. Doesn't exist yet.", sassLevel: 3, category: "technical", asiaContext: "Major research focus for Chinese and Japanese AI labs." },
  { term: "ASI", plain: "Artificial Superintelligence, a hypothetical AI surpassing human intelligence. Purely theoretical.", brutal: "Science fiction that VCs use to justify their valuations.", eli5: "A robot smarter than every person on Earth combined. Very much made up so far.", sassLevel: 3, category: "technical" },
  ...
  { term: "RLHF", plain: "Reinforcement Learning from Human Feedback, a method of training AI using human ratings of its outputs.", brutal: "Paying humans to tell AI when it's being weird.", eli5: "People tell the robot 'good answer' or 'bad answer' so it learns.", sassLevel: 1, category: "technical" },
  ...
  { term: "GPU", plain: "Graphics Processing Unit, the powerful chips that AI models run on.", brutal: "The reason NVIDIA is worth more than some countries.", eli5: "A super-fast computer chip that helps the robot think.", sassLevel: 1, category: "technical", asiaContext: "TSMC in Taiwan manufactures most of the world's AI chips." },
  ...
  { term: "mission-critical", plain: "Essential for the core operation of a business.", brutal: "Important. Just say important.", eli5: "Super important. You can't work without it.", sassLevel: 2, category: "corporate" },
  ...
  { term: "B2B", plain: "Business-to-business, meaning selling products or services to other companies.", brutal: "Selling to companies, not humans. The margins are better.", eli5: "Companies selling stuff to other companies.", sassLevel: 1, category: "startup" },
  ...
  { term: "ARR", plain: "Annual Recurring Revenue, the yearly subscription income.", brutal: "How much money comes in every year (before all the costs).", eli5: "Money that comes in every year like clockwork.", sassLevel: 1, category: "startup" },
  { term: "MRR", plain: "Monthly Recurring Revenue, the monthly subscription income.", brutal: "ARR divided by 12. Yes, it needed its own acronym.", eli5: "Money that comes in every month.", sassLevel: 1, category: "startup" },
