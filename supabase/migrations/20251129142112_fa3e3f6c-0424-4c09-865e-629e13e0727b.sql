...
-- Update bulk_operation_queue check constraint to include update_seo
...
CHECK (operation_type IN ('add_internal_links', 'generate_seo', 'generate_ai_comments', 'update_seo'));
